...
class Items extends Component {
  ...
  render() {
    const { items, positionX, positionY, show, onPress, width, height, containerStyle } = this.props;
    ...
    return (
      <View style={[containerStyle || styles.container, { top: positionY, left: positionX }]}>
        <ScrollView
